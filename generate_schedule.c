...
int main(int argc, char** argv){
    ...
    for(int league_week = 0; league_week < lastweek; league_week++){
        ...
        for(int match = 0; match < lastteam; match+=2){
            int team1, team2;
            int home, away;

            switch (lastteam){
                case 10:
                    team1 = round_robin_10[match][league_week % matchcount];
                    team2 = round_robin_10[match+1][league_week % matchcount];
                    break;
                case 12:
                    team1 = round_robin_12[match][league_week % matchcount];
                    team2 = round_robin_12[match+1][league_week % matchcount];
                    break;
                case 14:
                    team1 = round_robin_14[match][league_week % matchcount];
                    team2 = round_robin_14[match+1][league_week % matchcount];
                    break;
                case 16:
                    team1 = round_robin_16[match][league_week % matchcount];
                    team2 = round_robin_16[match+1][league_week % matchcount];
                    break;
                case 18:
                    team1 = round_robin_18[match][league_week % matchcount];
                    team2 = round_robin_18[match+1][league_week % matchcount];
                    break;
                case 20:
                    team1 = round_robin_20[match][league_week % matchcount];
                    team2 = round_robin_20[match+1][league_week % matchcount];
                    break;
                default:
